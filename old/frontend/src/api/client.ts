...
export const careersAPI = {
  list: (universityId?: string) =>
    api.get('/careers/', { params: universityId ? { university_id: universityId } : {} }),
  get: (id: string) => api.get(`/careers/${id}`),
}

// --- Subjects ---
export const subjectsAPI = {
  list: (params?: { career_id?: string; university_id?: string; semester?: number }) =>
...
export const reviewsAPI = {
  bySubject: (subjectCode: string, universityId?: string) =>
    api.get(`/reviews/subject/${subjectCode}`, { params: universityId ? { university_id: universityId } : {} }),
