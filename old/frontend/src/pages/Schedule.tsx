												...
												return (
													...
													>
														<div className="flex items-start justify-between gap-1">
															<p
																className={`font-medium text-sm leading-snug ${isSelected ? "text-primary" : "text-gray-900"}`}
															>
																{s.name}
															</p>
															{isSelected && (
							...
							<div className="mt-4 border-gray-100 border-t pt-4">
								...
								<div className="flex flex-wrap items-center gap-3">
									<div className="flex items-center gap-2">
										<label className="whitespace-nowrap font-medium text-gray-700 text-sm">
											Período:
										</label>
										<input
										...
										{activeDays.map((day) => {
											...
											if (block && block.start_time === hour) {
												return (
													<div
														key={day}
														className={`rounded-lg border p-1.5 text-xs ${dayColorMap[day] || "bg-gray-100"}`}
													>
	...
	return (
		<div className="rounded-xl bg-gray-50 p-3">
			...
			<div className="grid grid-cols-2 gap-2 md:grid-cols-4">
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Código *</label>
					<input
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Nombre</label>
					<input
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">
						Sección *
					</label>
					<input
						value={block.section}
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Profesor</label>
					<input
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Día *</label>
					<select
						value={block.day}
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Inicio *</label>
					<select
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Fin *</label>
					<select
				...
				<div>
					<label className="mb-0.5 block text-gray-500 text-xs">Aula</label>
					<input
